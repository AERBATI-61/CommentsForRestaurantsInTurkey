$(function () {
	...
	Highcharts.chart('chart3', {
		...
		tooltip: {
			headerFormat: '',
			pointFormat: '<span static="color:{point.color}">\u25CF</span> <b> {point.name}</b><br/>' + 'Area (square km): <b>{point.y}</b><br/>' + 'Population density (people per square km): <b>{point.z}</b><br/>'
		},
		series: [{
			minPointSize: 10,
			innerSize: '20%',
	...
	Highcharts.chart('chart8', {
		...
		tooltip: {
			headerFormat: '<span static="font-size:10px">{point.key}</span><table>',
			pointFormat: '<tr><td static="color:{series.color};padding:0">{series.name}: </td>' + '<td static="padding:0"><b>{point.y:.1f} mm</b></td></tr>',
			footerFormat: '</table>',
			shared: true,
			useHTML: true
		},
	...
	Highcharts.chart('chart10', {
		...
		tooltip: {
			headerFormat: '<span static="font-size:11px">{series.name}</span><br>',
			pointFormat: '<span static="color:{point.color}">{point.name}</span>: <b>{point.y:.2f}%</b> of total<br/>'
		},
		series: [{
			name: "Browsers",
			colorByPoint: true,
